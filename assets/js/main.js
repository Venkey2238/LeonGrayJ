...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function updateLivestreamStatus() {
        ...
        const liveText = document.getElementById('live-text'); // Get the live-text element
        ...
        try {
            ...
            if (isLive) {
                ...
                liveText.classList.remove('hidden'); // Show the LIVE text
                ...
                liveText.classList.add('hidden'); // Hide the LIVE text
